...
تتضمن وحدة اختبارات متقدمة مبنية خصيصاً على معمارية Electron Node (ABI-110) عبر جسر داخلي شفاف، تختبر 17 كتلة اختبار شاملة (تضم 70 فحصاً مؤكداً) تشمل:
...
- التحويل الثنائي لنوع الإجازة (مرضية ↔ اعتيادية) واسترجاع الأرصدة بدقة.
- التجهيز التلقائي لشرائح الموظف الجديد عند أول طلب إجازة مرضية.
- عزل واستثناء الموظف المنقول (`IsTransferred = 1`) بصرامة من استعلامات الإجازات اليومية السارية، والقوائم المُصفَّحة، وتنبيهات المباشرة القريبة، وكشوفات الأرصدة الحرجة، والتراكم السنوي وإجماليات الملخص.
