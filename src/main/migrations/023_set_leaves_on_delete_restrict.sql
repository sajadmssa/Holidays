-- ============================================================
--  migrations/023_set_leaves_on_delete_restrict.sql
--  Change Leaves.EmployeeID Foreign Key ON DELETE to RESTRICT
--  (Defense-in-Depth against accidental hard cascade deletes)
-- ============================================================
